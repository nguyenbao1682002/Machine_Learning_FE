...
KCECharts.defaultProps = {}

export function KCECharts(props: KCEChartsProps) {
  ...
  const options = React.useMemo(() => {
    return {
      ...
      yAxis: {
        type: 'value',
        boundaryGap: [0, '100%'],
        min: props.yMin ?? Math.round(Math.max(0, minValue - deltaMinMax / 2)),
        max: props.yMax ?? Math.round(maxValue + deltaMinMax / 2),
      },
      series: series,
    }
  }, [props.xAxisValues, props.yAxisLines, minValue, maxValue, props.yMin, props.yMax])
